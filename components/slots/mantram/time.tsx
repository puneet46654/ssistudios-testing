      ...
      <div className="bg-white p-7 rounded-3xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-slate-100 mb-6 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <span className="inline-flex items-center justify-center bg-indigo-50 text-indigo-600 font-extrabold text-[10px] px-2.5 py-1 rounded-full uppercase tracking-wider">
              Phase 1 of 3
            </span>
              ...
              <button
                ...
                className={`
                  ...
                  ${isBooked 
                    ...
                    : 'bg-white border-2 border-slate-100 text-slate-700 hover:bg-indigo-600 hover:text-white hover:border-indigo-600 hover:shadow-xl hover:shadow-indigo-600/15 hover:-translate-y-0.5 cursor-pointer'}
                `}
              >
                ...
                <span className={`text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full transition-colors ${
                  isBooked 
                    ...
                    : 'bg-emerald-50 text-emerald-700 group-hover:bg-indigo-700 group-hover:text-white'
                }`}>
